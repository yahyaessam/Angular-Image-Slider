...
var ImagesSliderModule = /** @class */ (function () {
    function ImagesSliderModule() {
    }
...
var ImagesSliderComponent = /** @class */ (function () {
    ...
    ImagesSliderComponent.prototype.ngOnInit = function () {
    ...
    ImagesSliderComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.height = (_this.width / 2) + 50;
        }, 1);
    };
    ImagesSliderComponent.prototype.moveSlider = function (dir) {
    ...
    ImagesSliderComponent.prototype.thumbsLeft = function (wrapperWidth) {
        var extra = ((((wrapperWidth / 100) % 1) * 100).toFixed(0));
        var moveTime = ((wrapperWidth / 100).toFixed(0));
        var loops = (this.images.length / moveTime).toFixed(0);
    ...
    ImagesSliderComponent.prototype.selectThumb = function (index) {
        var dir = index > this.counter ? 'next' : 'back';
